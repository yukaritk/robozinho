...
class PriceUpdateScreen:
    ...
    def build_ui(self):
        ...
        browse_button = ctk.CTkButton(frame, text="Browse", fg_color="#ec008c", hover_color="#bf0073", command=self.browse_file)
        browse_button.pack(pady=(10, 0), anchor="e", padx=20)
